    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card">
                ...
                <div class="card-body">
                    {{ Form::model($role, ['route' => ['role.update', encrypt(encrypt($role->id))], 'method' => 'PUT']) }}
                    <div class="form-group">
                        {{ Form::label('title', __('Role Title'), ['class' => 'form-label']) }}
                        {{ Form::text('title', $role->name, ['class' => 'form-control', 'placeholder' => __('Enter role title'), in_array($role->name, ['tenant', 'maintainer']) ? 'readonly' : '']) }}
                    </div>
                    <div class="card-body">
                        <div class="row">
