@php
    ...
    $default_landing_logo = asset(Storage::url('upload/logo/landing_logo.png'));
@endphp
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-lg-6 col-xl-6">
                        <h1 class="mt-sm-3 mb-sm-4 f-w-600 wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            @else
                                {{ __('FinanceLend SaaS - Loan Management Solution') }}
                            @endif
                        </h1>
                        <h4 class="mb-sm-4 text-muted wow fadeInUp" data-wow-delay="0.4s">
                            ...
                            @else
                                {{ __('The Loan Management System is a robust, scalable, and user-friendly software solution designed to streamline the management of loans for financial institutions, credit unions, and lending organizations. This system provides an end-to-end solution to automate the loan lifecycle, from application to approval, disbursement, and repayment, ensuring efficiency, accuracy, and compliance.') }}
                            @endif
                        </h4>
                        @php
                            ...
                            <div class="swiper-wrapper">
                                ...
                                @else
                                    <div class="swiper-slide">
                                        ...
                                        <p>{{ __('The Loan Management System is a robust, scalable, and user-friendly software solution designed to streamline the management of loans for financial institutions, credit unions, and lending organizations.') }}
                                        </p>
                                    </div>
                                    <div class="swiper-slide">
                ...
                <div class="row">
                    <div class="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <h4 class="my-3 text-white">
                            {{ !empty($Section_10_content_value['Sec10_title']) ? $Section_10_content_value['Sec10_title'] : 'About FinanceLend SaaS' }}
                        </h4>
                        <p class="mb-4 text-white text-opacity-75">
                            {!! !empty($Section_10_content_value['Sec10_info'])
                                ? $Section_10_content_value['Sec10_info']
                                : 'The Loan Management System is a robust, scalable, and user-friendly software solution designed to streamline the management of loans for financial institutions, credit unions, and lending organizations. This system provides an end-to-end solution to automate the loan lifecycle, from application to approval, disbursement, and repayment, ensuring efficiency, accuracy, and compliance.' !!}
                        </p>
                    </div>
                    <div class="col-md-8">
                        <div class="row g-4">
